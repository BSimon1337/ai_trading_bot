...
- [ ] T003 [P] Document reused existing modules/patterns and any approved deviations
- [ ] T004 [P] Record dependency decisions, including exact pinned npm versions and package-age verification when applicable
...
- [ ] T011 Add or update operational observability artifacts needed by all stories
...
- [ ] T019 [US1] Add logging, CSV/dashboard updates, or other operator-visible evidence for user story 1
...
- [ ] T026 [US2] Validate observability and risk controls for user story 2
...
- [ ] T032 [US3] Validate observability and risk controls for user story 3
...
- [ ] TXXX Re-verify dependency pinning and package-age requirements for newly added npm packages
