...
def _config_with_overrides(
    ...
    *,
    ...
    return MonitorConfiguration(
        ...
        historical_issue_limit=config.historical_issue_limit,
        archive_markers=config.archive_markers,
        ...
        runtime_event_limit=config.runtime_event_limit,
        active_warning_limit=config.active_warning_limit,
